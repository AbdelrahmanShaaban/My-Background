...
class PopularPagingSource @Inject constructor( private val getPhotosUseCase: GetPopularPhotos) : PagingSource<Int , Data>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Data> {
       val nextPage = params.key ?: Constants.FIRST_INDEX
        return try {
            val response = getPhotosUseCase.popularPhoto(nextPage)
            LoadResult.Page(
                data = response.data,
